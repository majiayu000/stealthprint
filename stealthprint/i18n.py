...
CATALOGS = {
    "en": {
        ...
        "err.no_key": "error: no API key (pass --api-key or set STEALTHPRINT_API_KEY; set STEALTHPRINT_USE_OPENCODE_AUTH=1 to allow opencode auth.json)",
    ...
    "zh": {
        ...
        "err.no_key": "错误：缺少 API key（用 --api-key 或设置 STEALTHPRINT_API_KEY；设置 STEALTHPRINT_USE_OPENCODE_AUTH=1 才允许读取 opencode auth.json）",
